    ...
    public partial class FrmProveedor : Form
    {
        ...
        private void BtnInsertar_Click_1(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Rpta = NPersona.Insertar("Proveedor", TxtNombre.Text.Trim(), CboTipoDocumento.Text, TxtNumeroDocumento.Text.Trim(), TxtDireccion.Text.Trim(), TxtTelefono.Text.Trim(), TxtEmail.Text.Trim());
        ...
        private void BtnActualizar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Rpta = NPersona.Actualizar(Convert.ToInt32(TxtId.Text),"Proveedor",this.NombreAnt , TxtNombre.Text.Trim(), CboTipoDocumento.Text, TxtNumeroDocumento.Text.Trim(), TxtDireccion.Text.Trim(), TxtTelefono.Text.Trim(), TxtEmail.Text.Trim());
                    if (Rpta.Equals("Ok")) // Respuesta ok de la inserción
                    {
